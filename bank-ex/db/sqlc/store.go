...
type Store struct {
	*Queries // embedding queries into store struct
	db       *sql.DB
}
...
func addMoney(ctx context.Context, q *Queries, accountID1, accountID2 int64, amount1, amount2 int64) (account1 Account, account2 Account, err error) {
